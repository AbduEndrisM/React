    ...
    return (
      <div className={classes.root}>
        ...
        <MuiThemeProvider>
          <div  align="center">
          <AppBar
                 title="Add User"  style={{ background: '#2E3B55', textAlign:"center" }}  showMenuIconButton={false} 
               />
           <TextField
           ...
           <TextField
             ...
             />
           <br/>
           <RaisedButton label="Add" color="primary" primary={true} style={style} onClick={(event) => this.handleClick(event)}/>
          </div>
         </MuiThemeProvider>
      </div>
        </main>
